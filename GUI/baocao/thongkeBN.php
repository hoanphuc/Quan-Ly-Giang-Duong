    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><small>Báo Cáo </small> Thống Kê Bệnh Nhân
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    ...
                    <?php if (isset($result)) echo '<div class="alert alert-danger alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><strong>Cảnh báo!</strong> '.$result.'</div>'; ?>
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="modal-footer">
                                <input type="submit" class="btn btn-success" name="btnBN" value="Xác nhận" tabindex="3" required/>
                                <input type="reset" class="btn btn-primary" value="Làm mới" />
                            </div>
                        <form>
                    </div>

                    <?php if(isset($ListthongkeBN)) { ?>
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                        <?php foreach ($ListthongkeBN as $i => $item) { ?>
                            <tr class="odd gradeX" align="center">
                                <td><?php echo $i + 1; ?></td>
                                <td><?php echo $item['SOPK']; ?></td>
                                <td><?php echo $item['SOBN']; ?></td>
                                <td><?php echo date("d-m-Y", strtotime($item['NGAYKHAM']));?></td>
                                <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="<?php echo MY_URL; ?>/BLL/baocao/CTBN.php?NgayKham=<?php echo $item['NGAYKHAM']; ?>"> Chi Tiết</a></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
                    ...
                    <div class="col-lg-7" style="padding-top:50px;padding-bottom:120px;">
                        <div class="form-group">
                            ...
                            <input type="number" value="<?php echo $tongBN['TONGBN'] ?>" Class="form-control" style="width: 70%" readonly />
                        </div>
                    </div>
                    <?php } ?>
                </div>
