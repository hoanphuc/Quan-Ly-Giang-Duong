    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><small>Sửa </small> Toa Thuốc
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    ...
                    <?php if (isset($result)) echo '<div class="alert alert-danger alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><strong>Cảnh báo!</strong> '.$result.'</div>'; ?>
                        ...
                        <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="5" Class="form-control" name="MaToa" style="width: 40%" value="<?php echo ((isset($_POST['MaToa'])) ? $_POST['MaToa'] : $tt['MATOA']); ?>" readonly tabindex="1" required/>
                            </div>
                            <div class="form-group">
                                <label>Phiếu Khám</label>
                                <select name="MaPK" class="form-control" style="width: 50%;" readonly tabindex="2" required>
                                    <?php foreach ($ListPK as $pk){ ?>
                                    <option value="<?php echo $pk['MAPK']; ?>" <?php echo (($tt['MAPK']==$pk['MAPK']) ? 'selected' : ''); ?>>
                                        <?php echo $pk['MAPK']; ?>
                                    </option>
                                    <?php } ?>
                        </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="NgayKeToa" Class="form-control" style="width: 50%" value="<?php echo ((isset($_POST['NgayKeToa'])) ? $_POST['NgayKeToa'] : $tt['NGAYKETOA']); ?>" tabindex="3" required />
                            </div>
                            <div class="form-group">
                                <label>Bác Sĩ Kê Toa</label>
                               <input type="text" Class="form-control" name="BacSiKeToa" style="width: 70%" value="<?php echo ((isset($_POST['BacSiKeToa'])) ? $_POST['BacSiKeToa'] : $tt['BACSIKETOA']); ?>" tabindex="4" required/>
                            </div>
                            <div class="modal-footer">
                                <input type="submit" class="btn btn-success" name="btnEditToaThuoc" value="Xác nhận" tabindex="5" required/>
