    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><small>Xóa </small> Toa Thuốc
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    <div class="col-lg-7" style="padding-bottom:120px;">
                        ...
                        <form action="" method="POST">
                            <div class="form-group">
                               ...
                               <input type="text" maxlength="5" Class="form-control" value="<?php echo $tt['MATOA']; ?>" style="width: 40%" readonly tabindex="1" required/>
                            </div>
                            <div class="modal-footer">
                                <input type="submit" class="btn btn-danger" name="btnDelToaThuoc" value="Xác nhận" tabindex="2" required/>
                                <a href="<?php echo MY_URL; ?>/BLL/toathuoc/ListToaThuoc.php" class="btn btn-default">Hủy bỏ</a>
                            </div>
                        </form>
                    <?php } elseif (isset($result)) { ?>
                        <p><?php echo $result; ?></p>
                        <div class="form-group">
                            <a href="<?php echo MY_URL; ?>/BLL/toathuoc/ListToaThuoc.php" class="btn btn-default">Trở về</a>
                        </div>
                    <?php } ?>
