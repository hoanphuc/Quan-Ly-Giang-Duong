    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><small>Lập </small> Toa Thuốc
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    ...
                    <?php if (isset($result)) echo '<div class="alert alert-danger alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><strong>Cảnh báo!</strong> '.$result.'</div>'; ?>
                        ...
                        <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="5" Class="form-control" name="MaToa" style="width: 40%" tabindex="1" required/>
                            </div>
                            <div class="form-group">
                                <label>Phiếu Khám</label>
                                <select name="MaPK" class="form-control" style="width: 50%;" tabindex="2" required>
                                    <?php foreach ($ListPK as $pk){ ?>
                                    <option value="<?php echo $pk['MAPK']; ?>">
                                        <?php echo $pk['MAPK']; ?>
                                    </option>
                                    <?php } ?>
                        </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="NgayKeToa" Class="form-control" style="width: 50%" tabindex="3" required />
                            </div>
                            <div class="form-group">
                                <label>Bác Sĩ Kê Toa</label>
                               <input type="text" Class="form-control" name="BacSiKeToa" style="width: 70%" tabindex="4" required/>
                            </div>
                            <div class="modal-footer">
                                <input type="submit" class="btn btn-success" name="btnAddToaThuoc" value="Xác nhận" tabindex="5" required/>
