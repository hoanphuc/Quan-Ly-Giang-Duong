    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><small>Danh Sách </small> Phiếu Khám
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                        <?php foreach ($ListPK as $i => $item) { ?>
                            <tr class="odd gradeX" align="center">
                                <td><?php echo $item['STT']; ?></td>
                                <td><?php echo $item['MAPK']; ?></td>
                                <td><?php echo $item['MABN']; ?> - <?php echo $dbBN->getBenhNhan($item['MABN'])[0]['HOTEN']; ?></td>
                                <td><?php echo date("d-m-Y", strtotime($item['NGAYKHAM']));?></td>
                                <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="<?php echo MY_URL; ?>/BLL/phieukham/DelPK.php?MaPK=<?php echo $item['MAPK']; ?>" onclick="return confirm('Bạn có chắc chắn muốn thực hiện thao tác xóa này ?');"> Xóa</a></td>
                                <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="<?php echo MY_URL; ?>/BLL/phieukham/EditPK.php?MaPK=<?php echo $item['MAPK']; ?>"> Sửa</a></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
