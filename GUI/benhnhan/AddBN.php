    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><small>Thêm </small> Bệnh Nhân
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    ...
                    <?php if (isset($result)) echo '<div class="alert alert-danger alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><strong>Cảnh báo!</strong> '.$result.'</div>'; ?>
                        ...
                        <form action="" method="POST">
                            <div class="form-group">
                               ...
                               <input type="text" maxlength="5" Class="form-control" name="MaBN" style="width: 40%" tabindex="1" required/>
                            </div>
                            <div class="form-group">
                                <label>Tên bệnh nhân</label>
                                <input type="text" Class="form-control" name="HoTen" style="width: 70%" tabindex="2" required/>
                            </div>
                            <div class="form-group">
                                <label>Ngày Sinh</label>
                                <input type="date" name="NgaySinh" Class="form-control" style="width: 50%" tabindex="3" required />
                            </div>
                            <div class="form-group">
                                <label>Địa chỉ</label>
                                <textarea name="DiaChi" Class="form-control" placeholder="Địa chỉ thường trú" rows="5" style="width: 80%" tabindex="4" required></textarea>
                            </div>
                            <div class="form-group">
                                <label>Số điện thoại</label>
                                <input name="SDT" maxlength="15" Class="form-control" id="sdt" style="width: 70%" type="text" tabindex="5" required/>
                            </div>
                            <div class="form-group">
                                <label>Giới tính</label><br>
                                <input type="radio" name="GioiTinh" id="gioitinh" tabindex="6" required value="nam" /> <label for="nam">Nam</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="GioiTinh" id="gioitinh" tabindex="6" required value="nữ" /> <label for="nu">Nữ</label> 
                            </div>
                            <div class="modal-footer">
                                <input type="submit" class="btn btn-success" name="btnAddBN" value="Xác nhận" tabindex="7" required/>
