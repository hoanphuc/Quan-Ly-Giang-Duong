    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><small>Xóa </small> Chi Tiết Toa Thuốc
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    <div class="col-lg-7" style="padding-bottom:120px;">
                        ...
                        <?php if (isset($cttt)) { ?>
                        <p>Bạn có chắc chắn muốn xóa: </p><br>
                        <form action="" method="POST">
                            <div class="form-group">
                                <label>Mã Toa Thuốc</label>
                               <input type="text" name="MaToa" maxlength="5" Class="form-control" value="<?php echo $cttt['MATOA']; ?>" style="width: 40%" readonly tabindex="1" required/>
                            </div>
                            <div class="form-group">
                                <label>Mã Toa Thuốc</label>
                                <select name="MaThuoc" class="form-control" style="width: 50%;" tabindex="2" required readonly>
                                    <?php foreach ($ListThuoc as $thuoc){ ?>
                                    <option value="<?php echo $thuoc['MATHUOC']; ?>" <?php echo (($cttt['MATHUOC']==$thuoc['MATHUOC']) ? 'selected' : ''); ?>>
                            ...
                            <div class="modal-footer">
                                <input type="submit" class="btn btn-danger" name="btnDelCTTT" value="Xác nhận" tabindex="7" required/>
                                <a href="<?php echo MY_URL; ?>/BLL/chitiettoathuoc/ListCTTT.php" class="btn btn-default">Hủy bỏ</a>
                            </div>
                        </form>
                    <?php } elseif (isset($result)) { ?>
                        <p><?php echo $result; ?></p>
                        <div class="form-group">
                            <a href="<?php echo MY_URL; ?>/BLL/chitiettoathuoc/ListCTTT.php" class="btn btn-default">Trở về</a>
                        </div>
                    <?php } ?>
