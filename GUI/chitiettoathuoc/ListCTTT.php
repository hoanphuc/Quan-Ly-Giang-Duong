    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><small>Danh Sách </small> Chi Tiết Toa Thuốc
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                        <?php foreach ($ListCTTT as $i => $item) { ?>
                            <tr class="odd gradeX" align="center">
                                <td><?php echo $i + 1; ?></td>
                                <td><?php echo $item['MATOA']; ?></td>
                                <td><?php echo $item['MATHUOC']; ?> - <?php echo $dbThuoc->getThuoc($item['MATHUOC'])[0]['TENTHUOC']; ?></td>
                                <td><?php echo $item['SOLUONG']; ?></td>
                                <td><?php echo $item['CACHDUNG']; ?></td>
                                <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="<?php echo MY_URL; ?>/BLL/chitiettoathuoc/DelCTTT.php?MaToa=<?php echo $item['MATOA']; ?>&MaThuoc=<?php echo $item['MATHUOC']; ?>" onclick="return confirm('Bạn có chắc chắn muốn thực hiện thao tác xóa này ?');"> Xóa</a></td>
                                <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="<?php echo MY_URL; ?>/BLL/chitiettoathuoc/EditCTTT.php?MaToa=<?php echo $item['MATOA']; ?>&MaThuoc=<?php echo $item['MATHUOC']; ?>"> Sửa</a></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
