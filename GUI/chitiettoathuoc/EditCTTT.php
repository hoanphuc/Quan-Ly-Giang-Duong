    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><small>Sửa </small> Chi Tiết Toa Thuốc
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                        ...
                        <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <select name="MaToa" class="form-control" style="width: 50%;" tabindex="1" required>
                                    ...
                                    <option value="<?php echo $tt['MATOA']; ?>" <?php echo (($cttt['MATOA']==$tt['MATOA']) ? 'selected' : ''); ?>>
                                        <?php echo $tt['MATOA']; ?>
                                    </option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="SoLuong" Class="form-control" style="width: 50%" value="<?php echo ((isset($_POST['SoLuong'])) ? $_POST['SoLuong'] : $cttt['SOLUONG']); ?>" tabindex="3" required />
                            </div>
                            <div class="form-group">
                                <label>Cách Dùng</label>
                                <textarea name="CachDung" Class="form-control" rows="5" style="width: 80%" tabindex="4" required><?php echo ((isset($_POST['CachDung'])) ? $_POST['CachDung'] : $cttt['CACHDUNG']); ?></textarea>
                            </div>
                            <div class="modal-footer">
                                <input type="submit" class="btn btn-success" name="btnEditCTTT" value="Xác nhận" tabindex="5" required/>
