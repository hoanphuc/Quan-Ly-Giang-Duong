    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><small>Thêm </small> Thuốc
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    ...
                    <?php if (isset($result)) echo '<div class="alert alert-danger alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><strong>Cảnh báo!</strong> '.$result.'</div>'; ?>
                        ...
                        <form action="" method="POST">
                            <div class="form-group">
                               ...
                               <input type="text" maxlength="5" Class="form-control" name="MaThuoc" style="width: 40%" tabindex="1" required/>
                            </div>
                            <div class="form-group">
                                <label>Tên Thuốc</label>
                                <input type="text" Class="form-control" name="TenThuoc" style="width: 70%" tabindex="2" required/>
                            </div>
                            <div class="form-group">
                                <label>Đơn Vị</label>
                                <input type="text" name="DonVi" Class="form-control" style="width: 50%" tabindex="3" required />
                            </div>
                            <div class="form-group">
                                <label>Đơn Giá</label>
                                <input type="number" name="DonGia" Class="form-control" style="width: 70%" tabindex="4" required />
                            </div>
                            <div class="form-group">
                                <label>Ngày Sản Xuất</label>
                                <input name="NSX" Class="form-control" style="width: 50%" type="date" tabindex="5" required/>
                            </div>
                            <div class="form-group">
                                <label>Hạn Sử Dụng</label><br>
                                <input name="HSD" Class="form-control" style="width: 50%" type="date" tabindex="6" required/> 
                            </div>
                            <div class="modal-footer">
                                <input type="submit" class="btn btn-success" name="btnAddThuoc" value="Xác nhận" tabindex="7" required/>
