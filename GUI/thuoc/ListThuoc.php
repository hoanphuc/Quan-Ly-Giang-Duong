    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><small>Danh Sách </small> Thuốc
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                        <?php foreach ($ListThuoc as $i => $item) { ?>
                            <tr class="odd gradeX" align="center">
                                <td><?php echo $i + 1; ?></td>
                                <td><?php echo $item['MATHUOC']; ?></td>
                                <td><?php echo $item['TENTHUOC']; ?></td>
                                <td><?php echo date("d-m-Y", strtotime($item['NSX']));?> - <?php echo date("d-m-Y", strtotime($item['HSD']));?></td>
                                <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="<?php echo MY_URL; ?>/BLL/thuoc/DelThuoc.php?MaThuoc=<?php echo $item['MATHUOC']; ?>" onclick="return confirm('Bạn có chắc chắn muốn thực hiện thao tác xóa này ?');"> Xóa</a></td>
                                <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="<?php echo MY_URL; ?>/BLL/thuoc/EditThuoc.php?MaThuoc=<?php echo $item['MATHUOC']; ?>"> Sửa</a></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
