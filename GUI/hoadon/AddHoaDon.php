    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><small>Lập </small> Hóa Đơn
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    ...
                    <?php if (isset($result)) echo '<div class="alert alert-danger alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><strong>Cảnh báo!</strong> '.$result.'</div>'; ?>
                        ...
                        <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="5" Class="form-control" name="MaHD" style="width: 40%" tabindex="1" required/>
                            </div>
                            <div class="form-group">
                                <label>Mã Toa</label>
                                <select name="MaToa" class="form-control" style="width: 50%;" tabindex="2" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="NgayBan" Class="form-control" style="width: 50%" tabindex="3" required />
                            </div>
                            <div class="form-group">
                                <label>Tiền Khám</label>
                               <input type="number" Class="form-control" name="TienKham" value="50000" style="width: 70%" tabindex="4" required/>
                            </div>
                            <div class="modal-footer">
                                <input type="submit" class="btn btn-success" name="btnAddHoaDon" value="Xác nhận" tabindex="5" required/>
