    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><small>Danh Sách </small> Hóa Đơn
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                        <?php foreach ($ListHoaDon as $i => $item) { ?>
                            <tr class="odd gradeX" align="center">
                                <td><?php echo $i + 1; ?></td>
                                <td><?php echo $item['MAHD']; ?></td>
                                <td><?php echo date("d-m-Y", strtotime($item['NGAYBAN']));?></td>
                                <td><?php echo $item['TONGTIEN']; ?></td>
                                <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="<?php echo MY_URL; ?>/BLL/hoadon/DelHoaDon.php?MaHD=<?php echo $item['MAHD']; ?>" onclick="return confirm('Bạn có chắc chắn muốn thực hiện thao tác xóa này ?');"> Xóa</a></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
